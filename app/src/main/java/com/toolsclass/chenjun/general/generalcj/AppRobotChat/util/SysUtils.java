...
public class SysUtils {
    ...
    public static void initFiles() {
        File file = new File(Environment.getExternalStorageDirectory(), "CJ/data");
        if (!file.exists())
            file.mkdirs();
        file = new File(Environment.getExternalStorageDirectory(), "CJ/images/upload");
        if (!file.exists())
            file.mkdirs();
        file = new File(Environment.getExternalStorageDirectory(), "CJ/images/cache");
        if (!file.exists())
            file.mkdirs();
        file = new File(Environment.getExternalStorageDirectory(), "CJ/download");
        if (!file.exists())
            file.mkdirs();
        file = new File(Environment.getExternalStorageDirectory(), "CJ/voice");
        if (!file.exists())
            file.mkdirs();
    }
    ...
    public static <T> void startActivity(Activity activity, Class<T> cla) {
        ...
        activity.overridePendingTransition(R.anim.robot_push_in_right, R.anim.robot_push_out_left);
    }
    ...
    public static void finish(Activity activity) {
        activity.finish();
        activity.overridePendingTransition(R.anim.robot_push_in_left, R.anim.robot_push_out_right);
    }
