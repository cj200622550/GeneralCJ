...
//        tvTemp.setText(mContext.getString(R.string.media_weather_temp, aMapLocalWeatherLive.getTemperature()));
//        tvCity.setText(aMapLocalWeatherLive.getCity());
//        tvWind.setText(mContext.getString(R.string.media_weather_wind, aMapLocalWeatherLive.getWindDir(),
...
//            if (hour >= 7 && hour < 19) {
//                resId = R.drawable.media_ic_weather_sunny;
//            } else {
//                resId = R.drawable.media_ic_weather_sunny_night;
//            }
//        } else if (weather.contains("多云")) {
//            if (hour >= 7 && hour < 19) {
//                resId = R.drawable.media_ic_weather_cloudy;
//            } else {
//                resId = R.drawable.media_ic_weather_cloudy_night;
//            }
//        } else if (weather.contains("阴")) {
//            resId = R.drawable.media_ic_weather_overcast;
//        } else if (weather.contains("雷阵雨")) {
//            resId = R.drawable.media_ic_weather_thunderstorm;
//        } else if (weather.contains("雨夹雪")) {
//            resId = R.drawable.media_ic_weather_sleet;
//        } else if (weather.contains("雨")) {
//            resId = R.drawable.media_ic_weather_rain;
//        } else if (weather.contains("雪")) {
//            resId = R.drawable.media_ic_weather_snow;
//        } else if (weather.contains("雾") || weather.contains("霾")) {
//            resId = R.drawable.media_ic_weather_foggy;
//        } else if (weather.contains("风") || weather.contains("飑")) {
//            resId = R.drawable.media_ic_weather_typhoon;
//        } else if (weather.contains("沙") || weather.contains("尘")) {
//            resId = R.drawable.media_ic_weather_sandstorm;
//        } else {
//            resId = R.drawable.media_ic_weather_cloudy;
//        }
//        return resId;
