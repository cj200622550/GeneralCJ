...
import com.toolsclass.chenjun.general.generalcj.adapter.BookAdapter;
...
public class BookFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void getData() {
        String reqUrl = Apis.SearchBookApi + "?q=" + mCurrentKeyWord + "&start=" + (mCurrentPageIndex - 1) * mPageSize + "&count=" + mPageSize;
