package com.toolsclass.chenjun.general.generalcj.Libs.sharelibrary;/**
...
import com.toolsclass.chenjun.general.generalcj.Libs.sharelibrary.cache.DiskCache;
import com.toolsclass.chenjun.general.generalcj.Libs.sharelibrary.cache.MemoryCache;
...
public final class Share {
     ...
     * 初始化
     */
    public static void init(String shareName, int cacheSize) {
        File file = new File(Environment.getExternalStorageDirectory().toString() + File.separator + "CJ/Share");
        if (!file.exists()) {
            file.mkdirs();
        }
        ...
        Share.diskCache = new DiskCache(cacheSize, file.toString(), 1);
