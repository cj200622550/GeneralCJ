...
public class FileUtils {
    ...
    private static String getAppDir() {
        return Environment.getExternalStorageDirectory() + "/CJ";
    }
    ...
    public static String getFileName(String artist, String title) {
        ...
        if (TextUtils.isEmpty(artist)) {
            artist = AppCache.getContext().getString(R.string.media_unknown);
        }
        if (TextUtils.isEmpty(title)) {
            title = AppCache.getContext().getString(R.string.media_unknown);
        }
        return artist + " - " + title;
    }
