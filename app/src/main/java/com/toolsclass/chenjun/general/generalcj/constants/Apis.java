package com.toolsclass.chenjun.general.generalcj.constants;
...
public class Apis {
     ...
     * 电影详细信息
     */
    public static String MovieDetailApi = "https://api.douban.com/v2/movie/subject/";
    /**
     * 正在热映
     */
    public static String MovieTheatersApi = "https://api.douban.com/v2/movie/in_theaters";
    /**
     * 即将上映
     */
    public static String MovieSoonApi = "https://api.douban.com/v2/movie/coming_soon";
    /**
     * Top250
     */
    public static String MovieTopApi = "https://api.douban.com/v2/movie/top250";
