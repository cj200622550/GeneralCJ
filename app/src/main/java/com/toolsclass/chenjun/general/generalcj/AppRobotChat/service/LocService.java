package com.toolsclass.chenjun.general.generalcj.AppRobotChat.service;
    ...
    public void initLocation() {
        ...
        mSearch.setOnGetGeoCodeResultListener(new OnGetGeoCoderResultListener() {
            ...
            public void onGetReverseGeoCodeResult(ReverseGeoCodeResult arg0) {//反地理编码
                ...
                LogUtils.e("当前位置：" +arg0.getAddress());
...
//                PreferencesUtils.putSharePre(LocService.this, Const.CITY, arg0.getAddressDetail().city);
                Share.putString(Const.ADDRESS,arg0.getAddress());
                Share.putString(Const.CITY,arg0.getAddressDetail().city);
        ...
        option.setScanSpan(3000);//设置定位请求间隔(此处为3s定位一次)
    ...
    public class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            LogUtils.e("当前坐标：" + mlongitude + "," + mlatitude);
//            PreferencesUtils.putSharePre(LocService.this, Const.LOCTION, mlongitude + "," + mlatitude);
            Share.putString(Const.LOCTION, mlongitude + "," + mlatitude);
        }
