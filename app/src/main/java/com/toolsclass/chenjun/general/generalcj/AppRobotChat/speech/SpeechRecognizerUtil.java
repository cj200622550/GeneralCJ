package com.toolsclass.chenjun.general.generalcj.AppRobotChat.speech;
...
public class SpeechRecognizerUtil {
    ...
    public void setParamIat() {
        ...
        // 设置语言
        String l = Share.getString(Const.XF_SET_VOICE_RECORD) == null ? "" : Share.getString(Const.XF_SET_VOICE_RECORD);
