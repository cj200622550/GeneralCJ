...
public class Preferences {
    ...
    public static boolean enableMobileNetworkPlay() {
        return getBoolean(sContext.getString(R.string.media_setting_key_mobile_network_play), false);
    }

    public static void saveMobileNetworkPlay(boolean enable) {
        saveBoolean(sContext.getString(R.string.media_setting_key_mobile_network_play), enable);
    }

    public static boolean enableMobileNetworkDownload() {
        return getBoolean(sContext.getString(R.string.media_setting_key_mobile_network_download), false);
    }

    public static void saveMobileNetworkDownload(boolean enable) {
        saveBoolean(sContext.getString(R.string.media_setting_key_mobile_network_download), enable);
    }
