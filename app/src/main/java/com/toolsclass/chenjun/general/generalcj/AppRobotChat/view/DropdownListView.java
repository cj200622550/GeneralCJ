package com.toolsclass.chenjun.general.generalcj.AppRobotChat.view;
...
//	private RotateAnimation reverseAnimation;
    ...
    private void init(Context context) {
        setCacheColorHint(context.getResources().getColor(R.color.robot_transparent));
        inflater = LayoutInflater.from(context);

        fl = (FrameLayout)inflater.inflate(R.layout.robot_dropdown_lv_head, null);
                    ...
                    if (state != REFRESHING && isRecored && state != LOADING) {
                        ...
                        if (state == PULL_To_REFRESH) {
                            ...
                            if ((tempY - startY) / RATIO >= headContentHeight) {
                                ...
                                LogUtils.v("由done或者下拉刷新状态转变到松开刷新");
                            }
                            // 上推到顶了
                            else if (tempY - startY <= 0) {
                                state = DONE;
                                ...
                                LogUtils.v( "由DOne或者下拉刷新状态转变到done状态");
                            }
                        }
    ...
    private void changeHeaderViewByState() {
        switch (state) {
            ...
            case REFRESHING:
                ...
                LogUtils.v("当前状态,正在刷新...");
                break;
            case DONE:
                headView.setPadding(0, -1 * headContentHeight, 0, 0);

                progressBar.setVisibility(View.GONE);
                LogUtils.v("当前状态，done");
                break;
        }
    }
