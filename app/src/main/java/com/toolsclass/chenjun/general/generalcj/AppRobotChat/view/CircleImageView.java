...
public class CircleImageView extends BaseImageView {
    ...
    private void sharedConstructor(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RobotCircleImageView);
        mShape = a.getInt(R.styleable.RobotCircleImageView_shape, Shape.CIRCLE);
        a.recycle();
    }
