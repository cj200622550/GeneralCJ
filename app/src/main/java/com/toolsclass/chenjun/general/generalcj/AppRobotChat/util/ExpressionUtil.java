...
import com.toolsclass.chenjun.general.generalcj.AppRobotChat.adapter.FaceGVAdapter;
import com.toolsclass.chenjun.general.generalcj.AppRobotChat.emoji.AnimatedGifDrawable;
import com.toolsclass.chenjun.general.generalcj.AppRobotChat.emoji.AnimatedImageSpan;
...
public class ExpressionUtil {
    ...
    public static View viewPagerItem(final Context context, int position, List<String> staticFacesList, int columns, int rows, final EditText editText) {
        ...
        View layout = inflater.inflate(R.layout.robot_face_gridview, null);//表情布局
