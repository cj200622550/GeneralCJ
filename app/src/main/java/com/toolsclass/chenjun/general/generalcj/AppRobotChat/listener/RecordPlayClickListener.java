package com.toolsclass.chenjun.general.generalcj.AppRobotChat.listener;
...
public class RecordPlayClickListener implements View.OnClickListener {
    ...
    public void startRecordAnimation() {
        iv_voice.setImageResource(R.drawable.robot_anim_chat_voice_right);
    ...
    public void stopRecordAnimation() {
        iv_voice.setImageResource(R.drawable.robot_voice_left3);
        if (anim != null) {
            anim.stop();
            anim=null;
        }
