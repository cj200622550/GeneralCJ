...
import com.toolsclass.chenjun.general.generalcj.AppMedia.adapter.PlayPagerAdapter;
import com.toolsclass.chenjun.general.generalcj.AppMedia.constants.Actions;
import com.toolsclass.chenjun.general.generalcj.AppMedia.enums.PlayModeEnum;
import com.toolsclass.chenjun.general.generalcj.AppMedia.executor.SearchLrc;
...
import com.toolsclass.chenjun.general.generalcj.AppMedia.utils.SystemUtils;
...
import com.toolsclass.chenjun.general.generalcj.AppMedia.widget.AlbumCoverView;
import com.toolsclass.chenjun.general.generalcj.AppMedia.widget.IndicatorLayout;
...
public class PlayFragment extends BaseFragment implements View.OnClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.media_fragment_play, container, false);
    }
    ...
    private void initViewPager() {
        View coverView = LayoutInflater.from(getContext()).inflate(R.layout.media_fragment_play_page_cover, null);
        View lrcView = LayoutInflater.from(getContext()).inflate(R.layout.media_fragment_play_page_lrc, null);
    ...
    private void onPlay(Music music) {
        ...
        mLastProgress = 0;
        tvCurrentTime.setText(R.string.media_play_time_start);
    ...
    private void switchPlayMode() {
        ...
        switch (mode) {
            case LOOP:
                ...
                ToastUtils.show(R.string.media_mode_shuffle);
                break;
            case SHUFFLE:
                mode = PlayModeEnum.SINGLE;
                ToastUtils.show(R.string.media_mode_one);
                break;
            case SINGLE:
                mode = PlayModeEnum.LOOP;
                ToastUtils.show(R.string.media_mode_loop);
                break;
        }
