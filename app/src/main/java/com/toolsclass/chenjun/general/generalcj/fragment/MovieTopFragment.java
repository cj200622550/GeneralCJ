...
public class MovieTopFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void getData() {
        String reqUrl = Apis.MovieTopApi + "?start=" + (mCurrentPageIndex - 1) * mPageSize + "&count=" + mPageSize;
