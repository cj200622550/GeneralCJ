...
public class CoverLoader {
    ...
    public Bitmap loadThumbnail(Music music) {
        ...
        if (TextUtils.isEmpty(path)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(), R.drawable.media_default_cover);
    ...
    public Bitmap loadBlur(Music music) {
        ...
        if (TextUtils.isEmpty(path)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(), R.drawable.media_play_page_default_bg);
    ...
    public Bitmap loadRound(Music music) {
        ...
        if (TextUtils.isEmpty(path)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(AppCache.getContext().getResources(), R.drawable.media_play_page_default_cover);
