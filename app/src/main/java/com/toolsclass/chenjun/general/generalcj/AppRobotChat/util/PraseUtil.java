...
import com.toolsclass.chenjun.general.generalcj.AppRobotChat.bean.InfoItem;
import com.toolsclass.chenjun.general.generalcj.AppRobotChat.bean.Infos;
import com.toolsclass.chenjun.general.generalcj.AppRobotChat.bean.InfosDto;
...
public class PraseUtil {
    ...
    public static Answer praseMsgText(String result) {
        ...
        try {
            ...
            //因为本人的key使用的是上线项目《聊天小公主》中的key，机器人名称被本人设定为了“小公主”，因此需要替换一下（个人重新申请的key不用替换） TODO
