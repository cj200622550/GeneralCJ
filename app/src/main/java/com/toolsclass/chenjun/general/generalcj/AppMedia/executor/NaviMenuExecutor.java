...
//import com.toolsclass.chenjun.general.generalcj.UtilityActivity.AboutActivity;
//
//
///**
// * 导航菜单执行器
...
//        if (minute > 0) {
//            ToastUtils.show(context.getString(R.string.media_timer_set, String.valueOf(minute)));
//        } else {
