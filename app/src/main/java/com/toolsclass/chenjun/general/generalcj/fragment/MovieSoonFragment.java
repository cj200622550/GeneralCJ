...
/**
 * 作者：陈骏 on 2017/5/15 17:16
 * QQ：200622550
 * 即将上映
 */

public class MovieSoonFragment  extends BaseFragment implements View.OnClickListener {
    ...
    private void getData() {
        String reqUrl = Apis.MovieSoonApi + "?start=" + (mCurrentPageIndex - 1) * mPageSize + "&count=" + mPageSize;
